...
@push('styles')
<style>
  /* ===== Card estilo minimal (como el mock) ===== */
  .auth-stage{
  ...
  select.in{padding-left:14px;appearance:auto}
  ...
  .btn-ghost{background:#fff;border:1px solid #e6e7eb;color:#1b1c1f}
  .btn-apple{background:#111;border:1px solid #111;color:#fff}
  .terms{margin:10px 0 0;text-align:center;color:#8B8E98}
  .terms a{color:#8B8E98;text-decoration:underline}
</style>
@endpush
  ...
  <div class="auth-card">
    ...
    <form method="POST" action="{{ route('register') }}" class="grid">
      ...
      <div class="field">
        ...
        <svg class="icon-l" viewBox="0 0 24 24" fill="none"><path stroke="#111827" stroke-width="1.6" stroke-linecap="round" stroke-linejoin="round" d="M15.5 7.5A4.5 4.5 0 1 1 6.5 7.5 4.5 4.5 0 0 1 15.5 7.5ZM20 21c0-4.418-4.03-8-9-8s-9 3.582-9 8"/></svg>
      ...
      <div class="field">
        ...
        <svg class="icon-l" viewBox="0 0 24 24" fill="none"><path stroke="#111827" stroke-width="1.6" stroke-linecap="round" stroke-linejoin="round" d="M3 6.75A2.25 2.25 0 0 1 5.25 4.5h13.5A2.25 2.25 0 0 1 21 6.75v10.5A2.25 2.25 0 0 1 18.75 19.5H5.25A2.25 2.25 0 0 1 3 17.25V6.75Z"/><path stroke="#111827" stroke-width="1.6" stroke-linecap="round" stroke-linejoin="round" d="m3 7 9 6 9-6"/></svg>
      ...
      <a href="{{ url('/auth/google/redirect') }}" class="btn-ghost">
        <svg height="18" width="18" viewBox="0 0 32 32" aria-hidden="true">
      ...
      {{-- Apple --}}
      <a href="{{ url('/auth/apple/redirect') }}" class="btn-apple">
        <svg preserveAspectRatio="xMidYMid" viewBox="0 0 256 315" height="20" width="16" aria-hidden="true">
          <path fill="#ffffff" d="M213.803394,167.030943 C214.2452,214.609646 255.542482,230.442639 256,230.644727 C255.650812,231.761357 249.401383,253.208293 234.24263,275.361446 C221.138555,294.513969 207.538253,313.596333 186.113759,313.991545 C165.062051,314.379442 158.292752,301.507828 134.22469,301.507828 C110.163898,301.507828 102.642899,313.596301 82.7151126,314.379442 C62.0350407,315.16201 46.2873831,293.668525 33.0744079,274.586162 C6.07529317,235.552544 -14.5576169,164.286328 13.147166,116.18047 C26.9103111,92.2909053 51.5060917,77.1630356 78.2026125,76.7751096 C98.5099145,76.3877456 117.677594,90.4371851 130.091705,90.4371851 C142.497945,90.4371851 165.790755,73.5415029 190.277627,76.0228474 C200.528668,76.4495055 229.303509,80.1636878 247.780625,107.209389 Z"/>
        </svg>
        <span>Registrarte con Apple</span>
      </a>

      <p class="terms">Al registrarte aceptas nuestros <a href="#">Términos de uso y Condiciones</a>.</p>
    </form>
