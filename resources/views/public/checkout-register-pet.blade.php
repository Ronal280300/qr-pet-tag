{{-- resources/views/public/checkout-register-pet.blade.php --}}
@extends('layouts.app')

@section('title', 'Registrar Mascota - Checkout')
  ...
  <div class="row justify-content-center">
    <div class="col-lg-10 col-xl-9">
      ...
      <div class="page-header mb-4">
        ...
        <div>
          <h1 class="page-title">Registrar Mascota {{ $currentPetNumber }} de {{ $totalPets }}</h1>
          <p class="page-subtitle">Completa la información de tu mascota - Pedido #{{ $order->order_number }}</p>
        </div>
      </div>

      <!-- Botón volver -->
      <div class="mb-4">
        <a href="{{ route('checkout.confirmation', $order) }}" class="btn btn-outline-secondary">
          <i class="fa-solid fa-arrow-left me-2"></i>Volver al resumen del pedido
        </a>
      </div>

      <form action="{{ route('checkout.store-pet', $order) }}" method="POST" enctype="multipart/form-data" id="pet-form">
        @csrf
                ...
                <div class="form-group">
                  ...
                  <div class="age-input-group">
                    <div class="input-with-icon flex-grow-1">
                      ...
                      <input type="number" name="age" min="0" max="50" class="form-input" placeholder="0" id="ageInputCheckout">
                    </div>
                    <select name="age_unit" class="form-select age-unit-select" id="ageUnitSelectCheckout">
        ...
        <div class="form-actions">
          ...
          <a href="{{ route('checkout.confirmation', $order) }}" class="btn-cancel">
            <i class="fa-solid fa-xmark"></i>
            Cancelar
          </a>
        </div>
...
<script>
  ...
  (function() {
    const ageInput = document.getElementById('ageInputCheckout');
    const ageUnitSelect = document.getElementById('ageUnitSelectCheckout');
