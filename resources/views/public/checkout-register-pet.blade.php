...
{{-- Incluir los estilos exactos de /portal/pets/create --}}
@include('public._pet-form-styles')
...
{{-- Incluir los scripts exactos de /portal/pets/create --}}
@include('public._pet-form-scripts')
@endpush
