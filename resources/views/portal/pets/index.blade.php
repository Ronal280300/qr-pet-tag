    ...
    <div id="petGrid" class="row g-3">
      ...
      <div class="col-12 col-sm-6 col-lg-4 col-xl-3 pet-item reveal"
        ...
        <div class="pet-card h-100 d-flex flex-column">
          <div class="pet-thumb">
            <img src="{{ $pet->main_photo_url }}" alt="{{ $pet->name }}" class="w-100"
              style="display:block;width:100%;height:220px;object-fit:cover;border-top-left-radius:12px;border-top-right-radius:12px;">
          </div>
