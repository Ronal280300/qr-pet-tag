...
return [
    ...
    */
    ...
    'attributes' => [
        ...
        'age_months' => 'meses de edad',
        'medical_conditions' => 'observaciones médicas',
        'sex' => 'sexo',
        'is_neutered' => 'esterilizado',
        'rabies_vaccine' => 'vacuna antirrábica',
        'has_emergency_contact' => 'contacto de emergencia',
        ...
        'pending_plan_id' => 'plan',
        'pets.*.name' => 'nombre de la mascota',
        'pets.*.breed' => 'raza de la mascota',
        'pets.*.photo' => 'foto principal de la mascota',
        'pets.*.zone' => 'ubicación de la mascota',
        'pets.*.age_years' => 'años de edad de la mascota',
        'pets.*.age_months' => 'meses de edad de la mascota',
        'pets.*.medical_conditions' => 'observaciones médicas de la mascota',
        'pets.*.sex' => 'sexo de la mascota',
        'pets.*.is_neutered' => 'esterilizado de la mascota',
        'pets.*.rabies_vaccine' => 'vacuna antirrábica de la mascota',
        'pets.*.emergency_contact_name' => 'nombre del contacto de emergencia de la mascota',
        'pets.*.emergency_contact_phone' => 'teléfono del contacto de emergencia de la mascota',
    ],
